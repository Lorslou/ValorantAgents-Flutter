...
/*
  it is listening to changes in the AuthBloc and AuthState. This BlocListener is used to perform 
  actions based on the current authentication (if registry) state.
*/
  @override
